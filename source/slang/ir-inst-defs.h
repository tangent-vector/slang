...
/* Types */
    ...
    INST_RANGE(UntypedBufferResourceType, HLSLByteAddressBufferType, HLSLRWByteAddressBufferType)

    /* HLSLPatchType */
        INST(HLSLInputPatchType,    InputPatch,     1, 0)
        INST(HLSLOutputPatchType,   OutputPatch,    1, 0)
...
/*IRParentInst*/
    ...
    INST_RANGE(GlobalValue, StructType, witness_table)
