    ...
    ConversionCost* outCost)
{
    ...
    // The handling of default-value and undefined-value literals is akin
    // to the cases above for initializer lists and null/none literals.
    // When these types appear as the "form" type of a coercion (e.g., because
    // they are being used to initialize a variable), it represents less of a
    // conversion and more of a request to construct a reasonable value of
    // the "to" type.
    //
    if (as<UndefinedLiteralType>(fromType))
    {
        ...
        // suitable constraints, where even the notion of an "undefined"
        ...
        // the IR already needs to contend with the possibility of undefined
        // values of any type.
        //
        if (outCost)
        {
    ...
    // e occurence of these types as the "from" type of a coercion provides
    // a signal that we should initialize 
